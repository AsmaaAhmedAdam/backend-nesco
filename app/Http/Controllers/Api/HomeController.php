...
class HomeController extends Controller
{
    ...
    */
     ...
     public function careers(Request $request)
    {
       ...
       // Check if an image is uploaded
            ...
            $image = $request->hasFile('upload') ? $request->file('upload') : null;

            // Send email
            Mail::to('asmaahome.work@gmail.com')->send(new SendcareerMail($data, $image));
         ...
         public function franchising(Request $request)
    {
        ...
        // Check if an image is uploaded
            ...
            $image = $request->hasFile('uploadFile') ? $request->file('uploadFile') : null;

            // Send email
            Mail::to('asmaahome.work@gmail.com')->send(new SendfileMail($data, $image));
  ...
  public function corporatelogin(Request $request)
  {
   ...
   $data = [
        ...
        // Send email
        Mail::to('asmaahome.work@gmail.com')->send(new SendImageMail($data, $image));
