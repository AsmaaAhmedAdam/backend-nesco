...
@section('main_title') {{ trans('home.edit_city') }}  @endsection

@section('top_title') {{ trans('home.edit_city') }}  @endsection
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 {{ $errors->has('en_name') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="en_name" class="form-control m-input" required="required" value="{{ $Item->en_name }}" placeholder=" {{ trans('home.en_name') }} ">
                    ...
                    <div class="col-sm-6 {{ $errors->has('ar_name') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="ar_name" class="form-control m-input" required="required" value="{{ $Item->ar_name }}" placeholder=" {{ trans('home.ar_name') }} ">
                    ...
                    <div class="col-sm-12 {{ $errors->has('shipping_value') ? ' has-error' : '' }}">
                        ...
                        <input type="number" min="0" name="shipping_value" onkeypress="return isNumberKey(event)" class="form-control m-input" value="{{ $Item->shipping_value }}" placeholder=" {{ trans('home.shipping_value') }}  ">
