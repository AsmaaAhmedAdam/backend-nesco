...
@section('main_title') {{ trans('home.add_page') }} @endsection

@section('top_title') {{ trans('home.add_page') }}  @endsection
...
<div class="row">
   ...
   <div class="col-md-12">
      ...
      <div class="card card-custom">
         ...
         <!--begin::Form-->
      {!!  Form::open(['url' => "admin_panel/site_pages/", 'role'=>'form','id'=>'add', 'files' => true,'method'=>'post']) !!}
