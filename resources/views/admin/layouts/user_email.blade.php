...
<head>
    <meta charset="utf-8" />
    <title>Reset Password  | Coffee Tea </title>
            ...
            <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
                ...
                <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                    ...
                    <a href="{{ url('admin_panel') }}" class="text-center mb-10">
                        <img src="{{asset('ebtsm-logo.jfif')}}" style="max-width: 200px;"  class="max-h-70px" alt="">
                    </a>
            ...
            <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
                ...
                <div class="d-flex flex-column-fluid flex-center">
                    ...
                    <div class="login-form">
                        <!--begin::Form-->
                        <form method="POST" action="{{ route('admin_panel.password.email') }}" class="m-login__form m-form">
                                @csrf
                            ...
                            <div class="form-group">
                                <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6" type="email" placeholder="Email" required name="email" value="{{ old('email') }}"/>
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group d-flex flex-wrap pb-lg-0 pb-3">
                                ...
                                <a href="{{ url('admin_panel/login') }}" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-4">Login</a>
                            </div>
                            <!--end::Form group-->
                ...
                <div class="d-flex justify-content-lg-start justify-content-center align-items-end py-7 py-lg-0">
                    <div class="text-dark-50 font-size-lg font-weight-bolder mr-10">
                        ...
                        <a href="https://www.ebtasm.com/" target="_blank" class="text-dark-75 text-hover-primary">Web Development ebtasm.com.eg</a>
                    </div>
                </div>
                <!--end::Content footer-->
